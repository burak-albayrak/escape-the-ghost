...
public class PlayerScript_lvl5 : MonoBehaviour
{
    private Rigidbody2D rb;

    public GameObject redGhostPrefab;
    public GameOverScreen GameOverScreen;
    [FormerlySerializedAs("scorePrefab")] public GameObject zeroPrefab;
    [FormerlySerializedAs("scorePrefab2")] public GameObject onePrefab;
    [FormerlySerializedAs("scorePrefab3")] public GameObject twoPrefab;
    [FormerlySerializedAs("scorePrefab4")] public GameObject threePrefab;
    ...
    void OnCollisionEnter2D(Collision2D col)
    {
        ...
        if (col.gameObject.CompareTag("Two") && !col.gameObject.CompareTag("Zero") && !col.gameObject.CompareTag("One"))
        {
            Destroy(col.gameObject);
        }
        
        if (col.gameObject.CompareTag("Three") && !col.gameObject.CompareTag("Zero") &&
            !col.gameObject.CompareTag("One") && !col.gameObject.CompareTag("Two"))
        {
            Destroy(col.gameObject);
        }

        if (col.gameObject.CompareTag("Prize") && !col.gameObject.CompareTag("Zero") &&
            !col.gameObject.CompareTag("One") && !col.gameObject.CompareTag("Two") && !col.gameObject.CompareTag("Three"))
        {
    ...
    void SpawnFour()
    {
        ...
        Instantiate(threePrefab, spawnPosition, Quaternion.identity);
    }
